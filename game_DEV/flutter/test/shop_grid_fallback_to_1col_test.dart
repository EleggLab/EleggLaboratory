...
void main() {
  ...
  testWidgets('shop offers fallback to single column below 360dp width', (
    tester,
  ) async {
    ...
    final buyElements = find.text('Buy').evaluate().toList();
    expect(buyElements.length, greaterThanOrEqualTo(2));
    final buyPositions =
        buyElements
    ...
    final firstPos = buyPositions[0];
    final secondPos = buyPositions[1];

    expect(secondPos.dy, greaterThan(firstPos.dy + 20));
