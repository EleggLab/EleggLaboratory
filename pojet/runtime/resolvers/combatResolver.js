import { CLASS_AI, DEFAULT_CLASS_AI, GEAR_POOL } from "../../src/config/runtimeData.js";
...
export function inferCombatAbility(classId) {
  ...
  if (["cleric", "druid"].includes(classId)) return "WIS";
  return "STR";
}
