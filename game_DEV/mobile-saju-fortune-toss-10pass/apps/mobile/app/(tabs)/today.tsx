...
export default function TodayFortuneScreen(): React.JSX.Element {
  ...
  return (
    ...
    >
      <View style={[commonStyles.hero, styles.header]}>
        ...
        <Text style={styles.heroSub}>별자리와 12지신 중에서 오늘 더 먼저 끌리는 쪽을 골라도 괜찮아요.</Text>
      </View>
      ...
      {!selection ? (
        <View style={styles.guideBand}>
          <View style={styles.guideChip}>
            ...
            <Text style={styles.guideChipText}>하나만 골라도 오늘 흐름이 열려요</Text>
          </View>
          <Text style={styles.guideCaption}>서양 별자리와 12지신 모두 같은 하루의 다른 결을 보여줘요.</Text>
        </View>
      ) : null}
        ...
        <>
          <View style={styles.topRow}>
            <View style={styles.topTagRow}>
              ...
              <View style={styles.metaChip}>
                <Text style={styles.metaChipText}>{selection.kind === 'western' ? '별자리 흐름' : '12지신 흐름'}</Text>
              </View>
            </View>
            <View style={styles.metaChip}>
              <Text style={styles.metaChipText}>KST {dateKey}</Text>
            </View>
          </View>
          ...
          <SectionCard title="선택 항목">
            <View style={styles.selectedPanel}>
              ...
              <Text style={styles.selectedCaption}>
                {selection.kind === 'western'
                  ? '오늘은 이 별자리의 기운을 중심으로 하루의 결을 읽어볼게요.'
                  : '해당 띠와 태어난 해를 함께 보면서 오늘의 흐름을 정리해볼게요.'}
              </Text>
            </View>
            ...
            {selection.kind === 'chinese' && chineseYears ? (
              <>
                ...
                <Text style={styles.yearHint}>같은 띠라도 태어난 해에 따라 표현이 조금씩 달라질 수 있어요.</Text>
              </>
            ) : null}
          </SectionCard>

          <SectionCard title="오늘 운세">
            <Text style={styles.detailLead}>짧은 결론보다 먼저, 오늘 흐름이 어느 쪽으로 기울고 있는지부터 읽어보세요.</Text>
