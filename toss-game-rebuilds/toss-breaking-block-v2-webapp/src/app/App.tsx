...
export function App() {
    ...
    return (
      <section className="screen">
        <div className="hero-card">
          ...
          <h1>브릭 스쿨 대작전</h1>
          <p className="hero-copy">막고, 깨고, 바로 다음 판. 한 판 2~3분으로 끝내여.</p>
    ...
    <section className="screen">
      <div className="panel-header">
        <div>
          ...
          <h1 className="screen-title">플레이 스타일을 골라여</h1>
        </div>
        <div className="inline-actions">
          <button
  ...
  const renderLibrary = () => (
    <section className="screen">
      <div className="panel-header">
        <div>
          <span className="eyebrow">연구소</span>
          <h1 className="screen-title">영구 업그레이드를 정비해여</h1>
        </div>
        <button className="ghost-button" type="button" onClick={() => setScene({ kind: 'lobby' })}>
          로비
        </button>
    ...
    <main className="app-shell">
      ...
      <div className="app-frame">
        <header className="top-banner">
          <div>
            <span className="eyebrow">브릭 트라이얼</span>
            <strong className="banner-title">브릭 스쿨 대작전</strong>
          </div>
        ...
        {scene.kind === 'boot' ? (
          <section className="screen">
            <div className="hero-card">
              ...
              <h1>브릭 아레나 입장 준비</h1>
              <p className="hero-copy">토스 게임 로그인과 저장 데이터를 확인하는 중이에여.</p>
            </div>
          </section>
        ) : null}
